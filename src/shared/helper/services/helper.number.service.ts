...
import { HelperNumberServiceInterface } from '../interfaces/helper.number-service.interface';

@Injectable()
export class HelperNumberService implements HelperNumberServiceInterface {
